    ...
    <div id="contact" className="py-16 pt-12 lg:py-24 lg:pt-20">
      <div className="container">
        <div className="bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 py-8 px-10 rounded-3xl text-center md:text-left relative overflow-hidden ">
          ...
          ></div>
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center relative z-30">
            <div>
            ...
            <a href="mailto:varunnkumar4@gmail.com">
              <button className="text-white inline-flex bg-gray-900 items-center px-6 h-12 rounded-xl gap-2 w-max border border-gray-900">
